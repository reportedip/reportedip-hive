...
namespace ReportedIP\Hive\Tests\Unit {
	...
	class AdminSurfaceParityTest extends TestCase {
		...
		private const NOT_REMOTE = array(
			...
			'reportedip_hive_form_proof_pow_version'     => 'Runtime state: the plugin version the computation was last armed for, so an update restarts the grace for pages a cache still holds.',
