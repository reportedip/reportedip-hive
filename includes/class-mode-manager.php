...
class ReportedIP_Hive_Mode_Manager {
	...
	private function feature_texts() {
		...
		$this->feature_texts_cache = array(
			...
			'form_adapters'                => array( __( 'Contact Form Protection', 'reportedip-hive' ), __( 'Carry the execution proof into Contact Form 7 and the Ultimate Member forms, so they are covered by the same check as the comment form and need no distorted image. An Ultimate Member sign-up also runs through the registration rules.', 'reportedip-hive' ) ),
