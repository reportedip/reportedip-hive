...
class ReportedIP_Hive_Mode_Manager {
	...
	private function feature_texts() {
		...
		$this->feature_texts_cache = array(
			...
			'form_adapters_advanced'       => array( __( 'Advanced Form Protection', 'reportedip-hive' ), __( 'The same protection on Gravity Forms, Formidable Forms, Formidable Forms PRO, Elementor Forms and the Ultimate Member forms. An Ultimate Member sign-up also runs through the registration rules.', 'reportedip-hive' ) ),
