...
final class ReportedIP_Hive_Settings_Registry {
	...
	public static function sections() {
		return array(
			...
			'forms'            => array(
				...
				'description' => __( 'The checks that sit on the comment form, the sign-up form, the password-reset form and the forms of Contact Form 7, WPForms, Gravity Forms, Forminator, Formidable Forms, Elementor and Ultimate Member. A visitor sees none of it, and nobody has to read a distorted image.', 'reportedip-hive' ),
			),
	...
	public static function spec() {
		return array(
			...
			'reportedip_hive_form_proof_um'                => array(
				'simple_form'  => 'ultimate_member',
				'section'      => 'forms',
				'kind'         => 'bool',
				'remote'       => true,
				'tier'         => 'form_adapters_advanced',
			...
			'reportedip_hive_form_proof_forminator'        => array(
				'simple_form'  => 'forminator',
				'section'      => 'forms',
				'kind'         => 'bool',
				'remote'       => true,
				'tier'         => 'form_adapters_advanced',
				'side_effects' => array( 'stamp_form_adapters_since' ),
				'label'        => __( 'Protect Forminator forms', 'reportedip-hive' ),
				'description'  => __( 'The same check on Forminator forms, whether the form sits in the page or is loaded afterwards. A refused submission is shown to the sender at the form, never dropped into a spam folder. Visitors notice nothing.', 'reportedip-hive' ),
			),
			...
			'reportedip_hive_audit_enabled'                => array(
				...
				'description' => __( 'Keep a separate, append-only record of who changed what: settings, plugins, pages, menus, files and accounts, each with the acting user.', 'reportedip-hive' ),
			),
			'reportedip_hive_audit_triggers'               => array(
				'ui_lock'     => 'audit_log',
				'choices'     => 'audit_groups',
				'section'     => 'privacy_logs',
				'kind'        => 'json_list',
				'json_filter' => array( 'ReportedIP_Hive_Audit_Registry', 'filter_groups' ),
				'remote'      => true,
				'label'       => __( 'Audit trail triggers', 'reportedip-hive' ),
				'description' => __( 'Which kinds of changes the audit trail records. Sign-ins are off by default because they are the loudest rows; the other groups are what a support case needs.', 'reportedip-hive' ),
			),
