		...
		wp_localize_script(
			...
			array(
				...
				'strings'   => array(
					...
					'passkeyTimeout'       => __( 'The request timed out or was cancelled. Insert your key and touch it — on a phone, hold the key flat against the back (NFC) — then try again.', 'reportedip-hive' ),
