...
final class ReportedIP_Hive_Score {
	...
	public static function hardening_items() {
		...
		return array(
			...
			self::item( 'security_headers', $w['security_headers'], 'hardening', __( 'Security headers (basic)', 'reportedip-hive' ), $headers_present && (bool) self::opt( 'reportedip_hive_security_headers_enabled', false ), self::url( 'reportedip-hive-firewall', 'hardening' ), 'security_headers', $headers_present ),
			self::item( 'security_headers_advanced', $w['security_headers_advanced'], 'hardening', __( 'Security headers (advanced)', 'reportedip-hive' ), $headers_present && (bool) self::opt( 'reportedip_hive_security_headers_advanced_enabled', false ), self::url( 'reportedip-hive-firewall', 'hardening' ), 'security_headers_advanced', $headers_present ),
